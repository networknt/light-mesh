...
import com.networknt.kafka.producer.ProduceRequest;
...
public class ConsumersGroupPostHandler implements LightHttpHandler {
    ...
    public void handleRequest(HttpServerExchange exchange) throws Exception {
        ...
        String instanceId = ConsumerStartupHook.kafkaConsumerManager.createConsumer(group, request.toConsumerInstanceConfig());
